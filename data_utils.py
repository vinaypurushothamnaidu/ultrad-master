...
master_train_loader = DataLoader(dataset = RESIDE_Dataset(path + '/MASTER/train', train = True), 
                             batch_size = BS, shuffle = True)

master_test_loader = DataLoader(dataset = RESIDE_Dataset(path + '/MASTER/val', train = False), 
